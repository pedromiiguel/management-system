...
import type { AddSaleItemInput, CompleteSaleInput, DiscountInput, Sale } from '@/domain/models/pos';
import {
...
} from '@/main/factories/mutations/pos';
 ...
 * continuam em presentation/pos/, que reage ao resultado de cada chamada.
 */
