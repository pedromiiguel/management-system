...
Management system for a beverage distributor / bar (Costa's Espetos): product catalog, stock, point-of-sale (PDV), customers, cash register, and financials. Domain language and UI copy are **Portuguese (pt-BR)** — keep it that way. The user-facing spec references FR-/NFR- requirement codes that appear in code comments.
